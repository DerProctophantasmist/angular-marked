...
function markedProvider() {
   ...
   */
markedDirective.$inject = ['marked', '$http', '$compile', 'Locale'];
function markedDirective(marked, $http, $compile, Locale) {
  return {
    restrict: 'AE',
    replace: true,
    scope: {
    ...
    link: function (scope, element, attrs) {
            ...
            var getContent = function (filename) {
                 ...
                 $http({method: 'get', url: filename}).then(function (response) {
